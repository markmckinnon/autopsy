...
public final class ContextViewer extends javax.swing.JPanel implements DataContentViewer {
    ...
    private List<javax.swing.JPanel> contextSourcePanels = new ArrayList<>();
    private List<javax.swing.JPanel> contextUsagePanels = new ArrayList<>();
    static {
...
//        jSourceGoToResultButton1.setVisible(false);
//        setSourceName("");
//        setSourceText("");
    }
    ...
    private void populateSourceContextData(AbstractFile sourceFile) throws NoCurrentCaseException, TskCoreException {
        ...
        if (!contextSourcePanels.isEmpty()) {
            jScrollPane1.add(new ContextSourcePanel("Unknow", "", null));
        } else
            for (javax.swing.JPanel sourcePanel : contextSourcePanels) {
                jScrollPane1.add(sourcePanel);
            }
        if (!contextUsagePanels.isEmpty()) {
            jScrollPane1.add(new ContextUsagePanel("Unknow", "", null));
        } else
            for (javax.swing.JPanel usagePanel : contextUsagePanels) {
                jScrollPane1.add(usagePanel);
            }
